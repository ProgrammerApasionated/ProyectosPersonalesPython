...
class Libro:
    ...
    @staticmethod
    # Usado en el repo de Progra II, el equivalente a un método estático.
    def from_linea(linea):
        titulo, autor, año, isbn, prestado = linea.strip().split(",")
        return Libro(titulo, autor, int(año), isbn, prestado == "True")
    # Crea un objeto con los datos de una línea con el formato -> Título,Autor,Año,ISBN,Prestado
    def to_linea(self):
